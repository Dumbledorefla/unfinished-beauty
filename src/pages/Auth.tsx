  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // useEffect above handles redirect on auth state change
      } else {
              ...
              <div className="space-y-3">
                ...
                >
                  <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.53-3.23 0-1.44.62-2.2.44-3.06-.4C3.79 16.17 4.36 9.02 8.55 8.8c1.18.06 2 .7 2.72.75.98-.2 1.91-.77 2.95-.7 1.24.1 2.17.58 2.78 1.48-2.56 1.52-1.95 4.87.6 5.81-.5 1.3-.76 1.88-1.55 3.03zM12.03 8.75c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                  </svg>
                  Entrar com Apple
                </Button>
              </div>
